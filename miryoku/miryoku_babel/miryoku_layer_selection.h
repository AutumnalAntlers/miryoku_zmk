...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_MAGIC_STURDY)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_MAGIC_STURDY_FLIP
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_ALPHAS_MAGIC_STURDY)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_MAGIC_STURDY
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_MAGIC_STURDY)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_MAGIC_STURDY_FLIP
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_EXTRA_MAGIC_STURDY)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_MAGIC_STURDY
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #endif
  #endif
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_MAGIC_STURDY)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_MAGIC_STURDY_FLIP
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH_FLIP
    #endif
  #else
    ...
    #elif defined (MIRYOKU_TAP_MAGIC_STURDY)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_MAGIC_STURDY
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH
    #endif
  #endif
