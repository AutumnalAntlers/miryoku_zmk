...
#define MIRYOKU_ALTERNATIVES_BASE_SOUL_FLIP \
&kp Q,             &kp W,             &kp L,             &kp D,             &kp P,             &kp K,             &kp M,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, R),    U_MT(LSHFT, T),    &kp G,             &kp F,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp J,             &kp B,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
#define MIRYOKU_ALTERNATIVES_BASE_SOUL \
&kp Q,             &kp W,             &kp L,             &kp D,             &kp P,             &kp K,             &kp M,             &kp U,             &kp Y,             &kp SQT,           \
U_MT(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, R),    U_MT(LSHFT, T),    &kp G,             &kp F,             U_MT(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp J,             &kp B,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP
...
#define MIRYOKU_ALTERNATIVES_TAP_SOUL_FLIP \
&kp Q,             &kp W,             &kp L,             &kp D,             &kp P,             &kp K,             &kp M,             &kp U,             &kp Y,             &kp SQT,           \
&kp A,             &kp S,             &kp R,             &kp T,             &kp G,             &kp F,             &kp N,             &kp E,             &kp I,             &kp O,             \
&kp Z,             &kp X,             &kp C,             &kp V,             &kp J,             &kp B,             &kp H,             &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              &kp DEL,           &kp BSPC,          &kp RET,           &kp TAB,           &kp SPACE,         &kp ESC,           U_NP,              U_NP
...
#define MIRYOKU_ALTERNATIVES_TAP_SOUL \
&kp Q,             &kp W,             &kp L,             &kp D,             &kp P,             &kp K,             &kp M,             &kp U,             &kp Y,             &kp SQT,           \
&kp A,             &kp S,             &kp R,             &kp T,             &kp G,             &kp F,             &kp N,             &kp E,             &kp I,             &kp O,             \
&kp Z,             &kp X,             &kp C,             &kp V,             &kp J,             &kp B,             &kp H,             &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              &kp ESC,           &kp SPACE,         &kp TAB,           &kp RET,           &kp BSPC,          &kp DEL,           U_NP,              U_NP
